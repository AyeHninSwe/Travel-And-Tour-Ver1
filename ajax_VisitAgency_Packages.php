...
{
	$query1="select AgencyId,Name,Picture from agency where AgencyId='".$AgencyId."'";
...
<body>';
	...
	echo "<a href='bookGUI.php'><input type='button' name='book' value='Book' class='buttons'></a>\t<a href='reviewForPackageGUI.php'><input type='button' name='reviews' value='Reviews' class='buttons'></a>";
			}

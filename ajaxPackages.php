...
{
	$query1="select AgencyId,Name,Picture from agency where AgencyId='".$feedItem['AgencyId']."'";
...
/*   		$_SESSION["PackageId"]=$feedItem['PackageId'];
		$_SESSION["agencyId"]=$feedItem['AgencyId'];*/
...
<body>';
    ...
    echo "<div style='padding: 4px 10px; float: left;'><a style='text-decoration:none; color:black;'  href='GetAgencyId.php?AgencyId=".$feedItem['AgencyId']."'><div class='agencyName' style='font-size:20px;' ><b>" . $name . "</b></div></a>";
	...
	echo "<a href='bookGUI.php?AgencyId=".$feedItem['AgencyId']."&PackageId=".$feedItem['PackageId']."'><input type='button' name='book' value='Book' class='buttons'></a>\t<a href='reviewForPackageGUI.php?ReviewPackageId=".$feedItem['PackageId']."'><input type='button' name='reviews' value='Reviews' class='buttons'></a>";
